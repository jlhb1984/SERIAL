...
;	PORTB,1: CHIP SELECT.
;	PORTB,2: LIBRE AIN0. MASTER SELECTED.
;	PORTB,3: LIBRE AIN1. SLAVE SELECTED.
;	PORTB,4: SS'.
;	PORTB,5: MISO.
;	PORTB,6: MOSI.
;	PORTB,7: SCK.
...
START:
	...
	LDI		R16,LOW(RAMEND)
	OUT		SPL,R16
	LDI		R16,0B11001110	;MASTER CONFIGURATION.	
	OUT		DDRB,R16
	LDI		R16,0B11111111
	OUT		DDRD,R16
...
MASTER:
	SBI		PORTB,1			;CHIP SELECT.
	LDI		R16,0B01010000	;SPIE=0 SPE=1 DORD=0 MSTR=1 CPOL=0 CPHA=0 SPR1SPR0=00 (FOSC/4)
	OUT		SPCR,R16
	LDI		R16,0B00000000
	OUT		SPSR,R16		;SPIE=F	SP=F _ _ _ SPI2X=0 _ _
	SBI		PORTB,2
